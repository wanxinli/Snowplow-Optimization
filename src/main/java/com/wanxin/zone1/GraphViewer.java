...
public class GraphViewer extends GraphStreamViewer {
	public static class StyleSheets {

		public static String BLUE_FOREST = "graph { fill-color: #141F2E; }" + "node {" + "	size: 7px, 7px;"
				+ "   fill-color: #A0FFA0;" + "	text-alignment: at-right;" + " 	stroke-mode: plain;"
				+ "	stroke-color: #999;" + "	stroke-width: 1.0;" + "	text-font: couriernew;"
				+ " 	text-offset: 2,-5;" + "	text-size: 8;" + "}" + "node.pickup {" + " 	fill-color: #6CC644;" + "}"
				...
				+ "node.removed {" + " 	fill-color: #FF8080;" + "	size: 10px, 10px;" + " 	stroke-mode: plain;"
				+ "	stroke-color: #CCF;" + "   stroke-width: 2.0;" + "   shadow-mode: gradient-radial;"
				+ "   shadow-width: 10px; shadow-color: #EEF, #000; shadow-offset: 0px;" + "}" +

				"edge {" + "	fill-color: #D3D3D3;" + "	arrow-size: 6px,3px;" + "}" + "edge.shipment {"
				+ "	fill-color: #999;" + "	arrow-size: 6px,3px;" + "}";

		public static String SIMPLE_WHITE = "node {" + "	size: 10px, 10px;" + "   fill-color: #6CC644;"
				+ "	text-alignment: at-right;" + " 	stroke-mode: plain;" + "	stroke-color: #999;"
				+ "	stroke-width: 1.0;" + "	text-font: couriernew;" + " 	text-offset: 2,-5;" + "	text-size: 8;" + "}"
				+ "node.pickup {" + " 	fill-color: #6CC644;" + "}" + "node.delivery {" + " 	fill-color: #f93;" + "}"
				...
				+ "   stroke-width: 2.0;" + "}" + "node.depot {" + " 	fill-color: #BD2C00;" + "	size: 10px, 10px;"
				+ " 	shape: box;" + "}" + "node.removed {" + " 	fill-color: #BD2C00;" + "	size: 10px, 10px;"
				+ " 	stroke-mode: plain;" + "	stroke-color: #333;" + "   stroke-width: 2.0;" + "}" +
	...
	public static String STYLESHEET = "node {" + "	size: 10px, 10px;" + "   fill-color: #6CC644;"
			+ "	text-alignment: at-right;" + " 	stroke-mode: plain;" + "	stroke-color: #999;"
			+ "	stroke-width: 1.0;" + "	text-font: couriernew;" + " 	text-offset: 2,-5;" + "	text-size: 8;" + "}"
			+ "node.pickup {" + " 	fill-color: #6CC644;" + "}" + "node.delivery {" + " 	fill-color: #f93;" + "}"
			+ "node.pickupInRoute {" + "	fill-color: #6CC644;" + " 	stroke-mode: plain;" + "	stroke-color: #333;"
			+ "   stroke-width: 2.0;" + "}" + "node.deliveryInRoute {" + " 	fill-color: #f93;" + " 	stroke-mode: plain;"
			+ "	stroke-color: #333;" + "   stroke-width: 2.0;" + "}" + "node.depot {" + " 	fill-color: #BD2C00;"
			+ "	size: 10px, 10px;" + " 	shape: box;" + "}" + "node.removed {" + " 	fill-color: #BD2C00;"
			+ "	size: 10px, 10px;" + " 	stroke-mode: plain;" + "	stroke-color: #333;" + "   stroke-width: 2.0;" + "}"
			+
	...
	public GraphViewer(VehicleRoutingProblem vrp) {
		super(vrp);
		this.vrp = vrp;
	}

	public GraphViewer(VehicleRoutingProblem vrp, VehicleRoutingProblemSolution solution) {
		super(vrp);
		this.vrp = vrp;
	...
	/**
	 * Sets the camera-view. Center describes the center-focus of the camera and
	 * zoomFactor its zoomFactor.
	 * <p>
	 * <p>
	...
	private JFrame createJFrame(ViewPanel view, double scaling) {
		...
		jframe.pack();
		jframe.setTitle("DelDOT Snowplow Optimization - ZONE1");
		return jframe;
	}
